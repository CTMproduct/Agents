...
14. **Group inventory is declared, not observed**, and never enters the ARI
   ledger. A block has TWO constraints — per-bedding maxima and a physical
   ceiling — and availability is derived from live requests, never stored as a
   counter.
